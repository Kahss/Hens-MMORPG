...
public class Anar extends Personnage {
	...
	public void Brulure(int fetiche, int def, int pui, Personnage enemy) {
	float enemyHP;
	float damage;
	enemyHP= enemy.getCurHp();
	damage=(float) (fetiche*(pui-def)*0.6);
	float newEnemyHP = enemyHP-damage;
	enemy.setCurHp(newEnemyHP);
