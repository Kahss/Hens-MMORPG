...
public class CreateCharacter extends BasicGameState implements ComponentListener, InputListener{
	...
	public void init(GameContainer container, StateBasedGame game)
		...
		ulmoBT = new MouseOverArea(container,new Image("image/ulmoBT.jpg"), 50, 140,this);
    	anarBT = new MouseOverArea(container,new Image("image/anarBT.jpg"), 200, 140,this);
    	wilwarBT = new MouseOverArea (container, new Image("image/wilwarBT.jpg"),350,140,this);
    	sulimoBT = new MouseOverArea (container, new Image("image/sulimoBT.jpg"),500,140,this);
    	ValidName = new MouseOverArea (container, new Image ("image/valid.jpg"), 50, 250,this);
    	EnterGame = new MouseOverArea (container, new Image ("image/valid.jpg"), 250, 700,this);
    	Type=0;
    	anarImg = new Image("image/anarBT.jpg");
    	wilwarImg = new Image("image/wilwarBT.jpg");
    	ulmoImg = new Image("image/ulmoBT.jpg");
    	sulimoImg = new Image("image/sulimoBT.jpg");
